...
class RestricaoService
{
  ...
  public function getTodasRestricoesNaData() {
    $select = 'SELECT HORARIO_INICIO, HORARIO_FIM FROM RESTRICAO WHERE  (DATA_INICIO IS NULL OR DATA_INICIO <= :DATA_AGENDAMENTO) AND (:DATA_AGENDAMENTO <= DATA_FIM OR DATA_FIM IS NULL)';
